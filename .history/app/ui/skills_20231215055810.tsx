  ...
  return (
    <section className='relative flex flex-col justify-center items-center pt-3'>
      <div className='flex items-start flex-col md:max-w-3xl py-10 w-full md:px-5 px-5 justify-between'>
        <h6
          className={`${comfortaa.className} text-[#142c3e] font-bold text-4xl hover:border-0 hover:text-[#142c3e] pb-6`}
        >
          02.Skills
        </h6>
        ...
        <div className='flex items-center gap-2'>
          <div className='flex items-center gap-1 md:hover:bg-slate-200 rounded-md px-5 bg-white text-black font-medium py-[0.45rem]'>
            <svg
              stroke='currentColor'
              fill='currentColor'
              stroke-width='0'
