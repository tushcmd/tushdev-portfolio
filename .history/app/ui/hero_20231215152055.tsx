...
export default async function Hero() {
  return (
    <section className='relative flex flex-col justify-center items-center md:py-16 py-6 overflow-auto'>
      <div className='flex items-center flex-col md:max-w-3xl pb-6 w-full md:px-5 px-5 justify-between'>
        ...
        <p className={`${comfortaa.className} text-4xl md:text-6xl text-white items-center`}>
          {hero.paragraph}
        </p>
      </div>
      <div className='flex flex-row md:max-w-3xl items-center pt-3 md:pt-5 pb-3 w-full md:px-5 px-5 justify-center space-x-5 md:space-x-20'>
        <svg
