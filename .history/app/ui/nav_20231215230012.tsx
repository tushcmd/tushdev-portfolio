...
export default async function Navbar() {
    ...
    useEffect(() => {
      const handleScroll = () => {
        ...
        if (header && window.scrollY > 250) {
          header.classList.add('fixed', 'shadow-after-3');
        } else if (header) {
          header.classList.remove('fixed', 'shadow-after-3');
        }
      };
  ...
  return (
    <header id='header' className='flex justify-center items-center transition-all duration-800'>
