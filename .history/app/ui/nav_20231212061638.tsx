...
export default async function Navbar() {
  return (
    <div className='fixed mx-auto container p-3 w-full flex flex-row border-b-0'>
      <div className='max-w-3xl items-center top-0 left-0 right-0 z-40'>
        <nav>
          <a className='family-comfortaa text-[20px] pt-2' href='/'>
            tush<span>.</span>
          </a>
