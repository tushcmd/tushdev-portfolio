...
export default async function Navbar() {
  return (
    <div className='container p-3 w-full flex justify-center items-center flex-row border-b-0'>
      <div className='max-w-3xl fixed top-0 left-0 right-0 z-40 transition-shadow duration-1000'>
