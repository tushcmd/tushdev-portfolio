          ...
          <ul className='grid grid-cols-2 gap-1 mt-5 md:grid-cols-4'>
            {skills.map((skill) => {
              ...
              return (
                <li
                  key={skill.id}
                  className='flex flex-col items-center gap-2 p-[20px] font-semibold rounded-md text-gray-400 bg-[#202020] opacity-1 transform scale-100 translate-x-0 translate-y-0'
                >
                  {icon}
                  {title}
                </li>
