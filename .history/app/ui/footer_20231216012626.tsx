...
export default async function Footer() {
  return (
    <section className='relative flex flex-col justify-center items-center pt-16 border-t-0'>
      <div className='flex flex-row md:max-w-3xl items-center gap-8 justify-center'>
        <p className={`${comfortaa.className} text-gray-50 text-2xl pt-3`}>Made with</p>
        <svg
          height='154.5'
      ...
      <div className='flex items-center flex-col md:max-w-3xl md:flex-row-reverse pt-5 pb-10 w-full md:px-5 px-5 justify-between border-t-0'>
        <div className='flex space-x-4 py-5 flex-row text-teal-950'>
          <a
            href='#'
        ...
        <div>
          <p className='text-teal-950 text-base '>
