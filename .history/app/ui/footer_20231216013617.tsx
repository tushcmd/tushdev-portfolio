...
export default async function Footer() {
  return (
    <section className='relative flex flex-col justify-center items-center pt-16 border-t-0'>
      <div className='flex flex-col md:flex-row md:max-w-3xl items-center gap-16 justify-center'>
        <p className={`${comfortaa.className} text-gray-400 text-2xl pt-3`}>Made with</p>
        <svg
          height='154.5'
