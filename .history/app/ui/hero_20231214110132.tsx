  ...
  return (
    <section className='relative flex flex-col justify-center items-center md:py-16 py-6'>
      <div className='flex items-start flex-col md:max-w-3xl pb-6 w-full md:px-5 px-5 justify-between'>
        <p className={`{inter.className} text-3xl text-white`}>
          Hi there, I&apos;m
        </p>
        <h6
          className={`{inter.className} text-5xl md:text-8xl text-[#D1D5DB] text-bold pb-3`}
        >
          {hero.name}
        </h6>
        <p className={`{inter.className} text-4xl md:text-6xl text-white`}>
          {hero.paragraph}
        </p>
      </div>
      <div className='flex flex-row md:max-w-3xl pt-5 md:pt-5 pb-3 w-full md:px-5 px-5 justify-center space-x-6'>
        <svg
