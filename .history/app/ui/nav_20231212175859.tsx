...
export default async function Navbar() {
  return (
    <div className='z-10 max-w-5xl w-full items-center justify-between font-mono text-sm lg:flex'>
      <div className=''>
        <nav className='fixed bottom-0 left-0 flex h-48 w-full items-start justify-center'>
          <a className={`${comfortaa.className} text-[20px]`} href='/'>
            tush<span>.</span>
          </a>
          <div className='fixed bottom-0 left-0 flex h-48 w-full items-end justify-center gap-2'>
            <a
