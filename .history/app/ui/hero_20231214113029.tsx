...
export default async function Hero() {
  return (
    <section
      role='banner'
      className='relative flex flex-col justify-center items-center md:py-16 py-6'
    >
      <div className='flex items-start flex-col md:max-w-3xl pb-6 w-full md:px-5 px-5 justify-between'>
        <h1 className={`${comfortaa.className} text-3xl text-white`}>
          Hi there, I&apos;m
        </h1>
        <h2
      ...
      <div className='flex flex-row md:max-w-3xl pt-3 md:pt-5 pb-3 w-full md:px-5 px-5 justify-center space-x-6'>
        <svg
