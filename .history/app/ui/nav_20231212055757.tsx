...
export default async function Navbar() {
  return (
    <div className='container p-3 w-full flex justify-center flex-row border-b-0'>
      <div className='max-w-3xl fixed items-center top-0 left-0 right-0 z-40 transition-shadow duration-1000'>
        <nav className='custom-container px-5 flex justify-between pt-5 pb-1'>
          <a className='family-comfortaa text-[20px]' href='/'>
            tush<span>.</span>
          </a>
          <div className='flex items-center gap-2'>
            <a
              ...
              target='_blank'
              rel='_noreferrer'
              className='flex items-center gap-1 bg-white transition-colors md:hover:bg-slate-200 rounded-md px-5 dark text-black font-medium py-[0.45rem]'
            >
              <svg
                stroke='currentColor'
                fill='currentColor'
