...
export default async function Hero() {
  return (
    <section className='relative md:max-w-3xl flex flex-col-reverse md:flex-row justify-center items-center h-screen md:py-16 py-6 overflow-auto'>
      <div>
        <div className='flex items-start flex-col py-6 w-full md:px-5 px-5 justify-between'>
