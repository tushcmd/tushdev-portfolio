...
export default function GetInTouch() {
  return (
    <section className='relative flex flex-col justify-center items-center'>
      <div className={`flex flex-col items-start justify-between pb-10 w-full ${containerClasses}`}>
        <div className='flex items-center'>
          <h6 className={`${textClasses.heading} inline-flex`}>
            Shoot me a message
            <span>
              <svg
        ...
        <p className={textClasses.paragraph}>
          My inbox is always open. If you have an interesting project idea, a question or just want to say hi, feel free to{' '}
          <span className='font-bold text-[#142c3e]'>get in touch</span>. I typically respond as fast as my next nearest break.
        </p>
        <div className='flex flex-row md:py-8 py-10 w-full justify-center space-x-12 md:space-x-20'>
