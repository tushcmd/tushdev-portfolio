      ...
      <div className={`flex items-center flex-col md:flex-row-reverse pt-5 pb-2 w-full justify-between border-t-0 ${containerClasses}`}>
        <div className='flex space-x-4 py-8 flex-row text-gray-400'>
          ...
          <a
            ...
            className='w-[21px] h-[21px] object-contain cursor-pointer'
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 21" role="img" fill="currentColor" className="h-5 w-5"><title>X / Twitter Icon</title><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"></path></svg>
          </a>
          <a
