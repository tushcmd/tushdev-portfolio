...
export default function ProjectsCard({ url, img, github, title, text }: Projects) {
    return (
        <div className="rounded-md text-gray-400 bg-[#202020] shadow-md hover:shadow-xl duration-300 lg:hover:scale-[1.10]">
            ...
            <div className='p-4'>
                ...
                <div className='mt-4 flex gap-x-4 pb-2'>
                    <a href={url} target='_blank' className='rounded-sm border border-[#142c3e]'>
                        <ExternalLink className='h-7 w-7 text-gray-400 hover:text-[#142c3e] duration-300 p-1' />
                    </a>
