...
//import { TextAnimate } from '../_components/ui/text-animate'
// Extracted styles
const textStyles = {
...
const heroTextClasses = {
  ...
  name: `${textStyles.comfortaa} text-4xl md:text-5xl pb-3`,
  paragraph: `${textStyles.montserrat} text-3xl md:text-4xl`,
};
        ...
        <div>
          ...
          <div className='flex flex-row pt-3 md:py-5 py-5 w-full justify-center space-x-12 md:space-x-20'>
            ...
            <div className='flex items-center gap-2'>
              <a
                href='https://drive.google.com/file/d/1-GErZBhE5zGBVzgnjcwkouLILuWlMmxc/view?usp=sharing'
                // href='https://drive.google.com/file/d/1Y6ltpcJoaDld2AxbKD947_Zlb4wvmxJ6/view?usp=drive_link'
                target='_blank'
                rel='_noreferrer'
